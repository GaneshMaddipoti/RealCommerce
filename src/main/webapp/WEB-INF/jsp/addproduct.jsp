...
<script>
	...
	$(document).ready(function() {
		$("#saveProductButton").click(function(e) {
			var postData = $("#product").serializeArray();
			var formURL = $("#product").attr("action");
			$.ajax({
				url : formURL,
				type : "POST",
				data : postData,
...
<div class="container" id="productCreate">
	<div class="row">
		<div class="col s12">
			<div class="card">
				<div class="card-content">
					<form:form method="POST" action="product/saveproduct"
						...
						<div id="productContent">
							...
							<div class="row">
								<div class="col s4">Product Description :</div>
								<div class="col s8">
									<form:input path="description" />
								</div>
							</div>
							<div class="row">
								<div class="col s4">Product Category :</div>
								<div class="col s8">
									<form:input path="category" />
								</div>
							</div>
							<input type="hidden" id="fieldCount"
								value="${fn:length(product.fields)}" />
						...
						<a href="#!" id="productContentAddButton"><i
							class="material-icons">add</i></a>
						<div class="row">
							<div class="col s12">
								<input type="button" value="Save Product" class="btn"
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#productContentAddButton").click(function() {
			...
			+ '</div>';
			$("#productContent").append(template);
			count++;
		});
	});
